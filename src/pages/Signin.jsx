...
<div className="flex items-center justify-center h-screen p-4">
  ...
  >
    <section className="w-[646.14px] h-[492.05px] m-auto rounded-2xl gap-7 border-2 border-red-500 ">
      <div >
        {/* login and Subtitle */}
...
<div className="relative w-full">
  ...
  />
      ...
      {/* Button */}
      <button className="block w-2/3 py-2 m-auto text-white bg-indigo-600 rounded-lg hover:bg-indigo-700">
        Login
      </button>
    </section>
  </div>
